...
tags:
  ...
  - CMake
  - 部署
timestamp: "2026-09-17T17:20:00+08:00"
resource:
  - CMakeLists.txt
  - CMakePresets.json
  - build.py
...
| 目录 | 数量 | 目录 | 数量 |
|---|---:|---|---:|
| `src/main.cpp` | 1 | `src/tools/` | 50 |
| `src/core/` | 9（含 editor_readiness.cpp、editor_coords.cpp） | `src/util/` | 7（skill_gen + skill_content_generated 构建期嵌入薄胶水） |
