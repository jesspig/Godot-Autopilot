...
JV handle_call_group(const JV& args) {
    LogSystem::instance().log(LogLevel::Info, LogCategory::Tools, "scene_tree_call_group called");
    ...
    if (ap && ap->IsArray()) {
        ...
        tree->call_group(
            godot::StringName(group_name.c_str()),
    ...
    JV r(JV::object_tag);
    r["result"] = JV("ok");
    LogSystem::instance().log(LogLevel::Info, LogCategory::Tools, "scene_tree_call_group completed");
    return r;
}

JV handle_create_timer(const JV& args) {
    LogSystem::instance().log(LogLevel::Info, LogCategory::Tools, "scene_tree_create_timer called");
    ...
    double delay = dp->IsDouble() ? dp->GetDouble() : static_cast<double>(dp->GetInt());
    ...
    LogSystem::instance().log(LogLevel::Info, LogCategory::Tools, "scene_tree_create_timer completed");
    return r;
}

JV handle_get_nodes_in_group(const JV& args) {
    LogSystem::instance().log(LogLevel::Info, LogCategory::Tools, "scene_tree_get_nodes_in_group called");
    auto* gn = args.Find("group_name");
    if (!gn || !gn->IsString()) {
        JV e(JV::object_tag);
        e["error"] = JV("missing required parameter: group_name");
    ...
    LogSystem::instance().log(LogLevel::Info, LogCategory::Tools, "scene_tree_get_nodes_in_group completed");
    return r;
}

JV handle_is_paused(const JV&) {
    LogSystem::instance().log(LogLevel::Info, LogCategory::Tools, "scene_tree_is_paused called");
    auto* tree = get_tree();
    if (!tree) {
        JV e(JV::object_tag);
        e["error"] = JV("SceneTree not available");
    ...
    JV r(JV::object_tag);
    r["result"] = JV(paused);
    LogSystem::instance().log(LogLevel::Info, LogCategory::Tools, "scene_tree_is_paused completed");
    return r;
}

JV handle_notify_group(const JV& args) {
    LogSystem::instance().log(LogLevel::Info, LogCategory::Tools, "scene_tree_notify_group called");
    auto* gn = args.Find("group_name");
    if (!gn || !gn->IsString()) {
        JV e(JV::object_tag);
        e["error"] = JV("missing required parameter: group_name");
    ...
    JV r(JV::object_tag);
    r["result"] = JV("ok");
    LogSystem::instance().log(LogLevel::Info, LogCategory::Tools, "scene_tree_notify_group completed");
    return r;
}

JV handle_reload_current_scene(const JV&) {
    LogSystem::instance().log(LogLevel::Info, LogCategory::Tools, "scene_tree_reload_current_scene called");
    auto* tree = get_tree();
    if (!tree) {
        JV e(JV::object_tag);
        e["error"] = JV("SceneTree not available");
    ...
    LogSystem::instance().log(LogLevel::Info, LogCategory::Tools, "scene_tree_reload_current_scene completed");
    return r;
}

JV handle_set_debug_collisions(const JV& args) {
    LogSystem::instance().log(LogLevel::Info, LogCategory::Tools, "scene_tree_set_debug_collisions called");
    ...
    JV r(JV::object_tag);
    r["result"] = JV("ok");
    LogSystem::instance().log(LogLevel::Info, LogCategory::Tools, "scene_tree_set_debug_collisions completed");
    return r;
}

JV handle_set_pause(const JV& args) {
    LogSystem::instance().log(LogLevel::Info, LogCategory::Tools, "scene_tree_set_pause called");
    ...
    JV r(JV::object_tag);
    r["result"] = JV("ok");
    LogSystem::instance().log(LogLevel::Info, LogCategory::Tools, "scene_tree_set_pause completed");
    return r;
}
