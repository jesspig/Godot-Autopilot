...
GDA_TOOL_CLASS(SequenceGameInputsTool, "sequence_game_inputs",
               ...
               "Game", std::vector<std::string>({"game", "runtime", "input", "sequence", "timeline", "debug"}), runtime_ops::handle_sequence_game_inputs, true)
