...
mcp::JsonValue handle_3d_body_add_collision_exception(const mcp::JsonValue& args);
mcp::JsonValue handle_3d_body_remove_collision_exception(const mcp::JsonValue& args);
