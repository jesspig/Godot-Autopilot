...
- Default operation timeout is 5000 ms; the maximum accepted timeout is 30000 ms (game ops cap `timeout_ms` at 25000 ms, keeping the host wait plus a 2000 ms grace below the 30 s transport limit).
